...
const translations = {
    en: {
        ...
        drop_error_title: "Failed to load content",
        drop_error_desc: "Something went wrong. Check your connection and try again.",
        drop_error_retry: "Retry",
        ...
        analysis_in_progress: "Analyzing audio waveform…",
    ...
    th: {
        ...
        drop_error_title: "ไม่สามารถโหลดเนื้อหาได้",
        drop_error_desc: "เกิดข้อผิดพลาด กรุณาตรวจสอบการเชื่อมต่อแล้วลองอีกครั้ง",
        drop_error_retry: "ลองใหม่",
        ...
        analysis_in_progress: "กำลังวิเคราะห์คลื่นเสียง…",
        encoding_label: "กำลังเข้ารหัส…",
